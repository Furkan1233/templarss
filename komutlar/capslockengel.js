...
exports.run = async (client, message, args) => {
  ...
  if (capslock) {
    ...
    message.channel.send(`Capslock Engelleme Sistemi Kapatıldı <a:B_Veriflied:804447791823847424>`)
  }
 
  if (!capslock) {
    db.set(`capslock_${message.guild.id}`, 'acik')
    message.channel.send(`Capslock Engelleme Sistemi Aktif <a:B_Veriflied:804447791823847424>`)
  }
};
exports.conf = {
  enabled: true,
